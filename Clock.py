...
class Clock:
     def __init__(self,root):
          ...
          self.lbl.place(x=450,y=200,height=400,width=400)         
          self.working()
     ...
     def  clock_image(self,hr,min_,sec_):
          ...
          origin=200,200
          draw.line((origin,200+50*sin(radians(hr)),200-50*cos(radians(hr))),fill="yellow",width=4)
          draw.line((origin,200+80*sin(radians(min_)),200-80*cos(radians(min_))),fill="White",width=3)
          draw.line((origin,200+100*sin(radians(sec_)),200-100*cos(radians(sec_))),fill="orange",width=4)
